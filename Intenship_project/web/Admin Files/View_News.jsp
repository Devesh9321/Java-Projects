<%-- 
    Document   : View_News
    Created on : 21-Jan-2023, 12:28:50 am
    Author     : : Devesh Patil
--%>
...
<body>
<%
	PreparedStatement ps = Connector.getConnect().prepareStatement("Select * from news_update;");
...
%>
    ...
    <header class="text-gray-600 body-font">
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            <nav
                ...
                <a class="mr-5 hover:text-gray-900" href="./View_News.jsp"
    ...
    <section>
        <div class="just_cent ">
            ...
            <h1 class="heading1"> Update News View </h1>

            <table class="inform fullTable ">
                <tr style="background-color:rgb(0, 140, 255) ;">
                    <th>Sr No</th>
                    <th>Heading</th>
                    <th>Description</th>
                    <th>Date</th>
...
%>
 ...
 <footer class="text-gray-600 body-font">
    <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col"  style="position:absolute; bottom: 0; display:flex;justify-content: center;align-items: center;">
